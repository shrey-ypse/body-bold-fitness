...
export const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        fullDescription: "Maximize your workout efficiency with the Body Bolt Cross Trainer. This machine offers a low-impact solution for joint-safe cardio, targeting your core, arms, and legs simultaneously. Perfect for home gyms in Hyderabad where space and performance are key.",
    ...
    },
    {
        ...
        fullDescription: "The Body Bolt Air Bike uses wind resistance to provide an infinite level of challenge. The harder you pedal, the higher the resistance. Featuring synchronized handle movement, it’s the best tool for high-intensity interval training (HIIT) in your home gym setup.",
    ...
    },
    {
        ...
        specs: { "Material": "Industrial MS Steel", "Coating": "Hard Chrome", "Sizes": "3ft to 7ft", "Location": "Body Bolt Shaikpet" },
        price: "₹330+",
    ...
    },
    {
        ...
        fullDescription: "The Body Bolt Adjustable Orbitrek is a versatile cardio hub. Featuring a heavy-duty flywheel and multiple tension levels, it adapts to your progress. Ideal for full-body toning and endurance building in Hyderabad home gyms.",
